...
import 'package:flutter_weather/WeatherBloc.dart';
import 'package:flutter_weather/WeatherModel.dart';
import 'package:flare_flutter/flare_actor.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:flutter_weather/WeatherRepo.dart';
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                Column(
                  children: <Widget>[
                    Text(weather.getMinTemp.round().toString()+"F",style: TextStyle(color: Colors.white70, fontSize: 30),),
                    Text("Min Temprature",style: TextStyle(color: Colors.white70, fontSize: 14),),
                  ],
                ),
                Column(
                  children: <Widget>[
                    Text(weather.getMaxTemp.round().toString()+"F",style: TextStyle(color: Colors.white70, fontSize: 30),),
